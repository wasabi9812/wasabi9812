...
|-------|-------|------|------|-----------------|
| Semantic-based Offset Estimation for Time Synchronization of Multi-sensor Systems in Vehicles | IEMEK Journal (KCI) | 2025-08 | [IEMEK](http://journal.iemek.org/MN/) | 악의 조건주행 환경에서 연속 대응 가능한 Hyper 자차 위치 인식 기술 개발 |
